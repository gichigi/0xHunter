    ...
    <div className="min-h-screen bg-black text-white relative overflow-hidden">
      ...
      <main className="relative max-w-4xl mx-auto px-4 sm:px-6 py-8 sm:py-16">
        <div className="text-center mb-8">
          <h2 className="text-3xl sm:text-4xl font-serif mb-4 text-white drop-shadow-lg">Simple Test</h2>
          <p className="text-gray-300 font-serif mb-8">Testing basic connection...</p>
            ...
            >
              ...
              {testResult.success && testResult.data && (
                <div className="space-y-4">
                  <div className="bg-gray-900/50 rounded p-4">
                    <h4 className="text-white font-serif mb-2">Block Number:</h4>
                    <p className="text-gray-300 font-mono">{testResult.data.blockNumber}</p>
                  </div>
                </div>
              )}
              ...
              {!testResult.success && testResult.error && (
                <div className="bg-red-900/20 rounded p-4 mt-4">
                  <h4 className="text-red-400 font-serif mb-2">Error:</h4>
